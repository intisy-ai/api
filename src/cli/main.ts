...
import { isPluginError, setDiagnosticSink, validateManifest } from "../../generated/engine.js";
import { readCheckout } from "./read.js";
import { formatValidation, USAGE } from "./report.js";
...
export function run(argv: string[], io: CliIo): number {
  ...
  try {
    ...
    io.err(isPluginError(error) ? String((error as { message?: unknown }).message) : String(error));
    return 1;
  } finally {
